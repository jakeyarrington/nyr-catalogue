...
(function($) {
    ...
    const cdn_url = is_local ? 'http://192.168.0.88:8080/mockdata/' : 'https://app.nyrcatalogue.com/app';
        ...
        $scope.start_tutorial = function() {
            ...
            introJs().setOptions({
              ...
              }, 
              {
                ...
                intro: "At the top right of your screen are notification popups, these will either tell you if there is items available to view or other important notifications."
              },
              {
                element: $('nav div.nav-wrapper')[0],
                intro: "This is the Sidebar which lists out all available links whilst you're browsing the Catalogue."
              },
              {
                element: $('#nav-mobile li:nth-child(1)')[0],
                intro: "The NYR Organic logo links you directly to the Consultants shop at any time."
              },
              {
                element: $('#nav-mobile li:nth-child(2)')[0],
                intro: "This is the Available Item viewer. When you are browsing the catalogue, any items that are available in the page will appear as a sidebar slide out when you select this button. You can see that there are some items available to view on this page. Let's go ahead and open the sidebar.."
              },
        ...
        var response = {
            ...
            set: function(data) {
                ...
                if(typeof this.data.welcome_message !== 'undefined' && !this.data.welcome_message) {
                    ...
                    $scope.consultant_query.welcome = this.data.welcome_message;
                }
