        ...
        $scope.start_tutorial = function() {
            ...
            introJs().setOptions({
              ...
              }, 
              {
                ...
                intro: "At the top right of your screen are notification popups, these will either tell your customers if there is items available to view or other important notifications."
              },
              {
              ...
              },
              {
                ...
                intro: "The NYR Organic logo links your customers directly to the your NYR Organic shop at any time."
              },
              {
                                        ...
                                        if(party_session == null) {
                                            ...
                                            .done(function(e) {
                                                ...
                                                if(e.success) {
                                                    ...
                                                    localStorage.setItem(party.id + '_timeout', (new Date().getTime()));
                                                } else {
                                                    if(party.name) {
                                                        M.toast({
                                            ...
                                            if(ten_minutes_from_now >= party_link_timeout) {
                                                console.log('Expired party BID', (ten_minutes_from_now - party_link_timeout));
